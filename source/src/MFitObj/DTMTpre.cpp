#include <MFitObj/DTMTpre.h>
using namespace std;

DTMTpre::DTMTpre(int maxNodes, int minPtsNode, int treeMaxLevels, int nthreads)
...
void DTMTpre::fit()
{
	...
	//memset((void*)&DTBase::viNode[0], 0, ncols_ * sizeof(int));
...
double DTMTpre::TnodeCutFn(Acc& acc, Acc& tot, int cutpts, int weirdFactor)
{
/*
