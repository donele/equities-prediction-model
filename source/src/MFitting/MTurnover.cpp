...
MTurnover::MTurnover(const string& moduleName, const multimap<string, string>& conf)
...
void MTurnover::beginDay()
{
}

void MTurnover::endDay()
{
}

void MTurnover::endJob()
{
	write_trees();
}

void MTurnover::write_trees()
{
	const hff::LinearModel linMod = MEnv::Instance()->linearModel;
...
int MTurnover::getDBDate(const string& market)
{
	char syyyymmdd[128];
	char shhmmss[128];
	struct tm* now;
