#ifndef __HOrderSummRead__
#define __HOrderSummRead__
...
class CLASS_DECLSPEC HOrderSummRead: public HModule {
public:
	HOrderSummRead(const std::string& moduleName, const std::multimap<std::string, std::string>& conf);
	virtual ~HOrderSummRead();
