#ifndef __HNNReadRoot__
#define __HNNReadRoot__
...
class CLASS_DECLSPEC HNNReadRoot: public HModule {
public:
	HNNReadRoot(const std::string& moduleName, const std::multimap<std::string, std::string>& conf);
	virtual ~HNNReadRoot();
