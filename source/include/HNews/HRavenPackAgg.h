#ifndef __HRavenPackAgg__
#define __HRavenPackAgg__
#include <HLib/HModule.h>
#include <HNews/CompaniesRP.h>
...
class CLASS_DECLSPEC HRavenPackAgg: public HModule {
public:
	HRavenPackAgg(const std::string& moduleName, const std::multimap<std::string, std::string>& conf);
	virtual ~HRavenPackAgg();
...
private:
	...
	public:
		...
		std::vector<int> get_market_sent();
...
private:
	...
	void import_market(TickStorage<QuoteInfo>& tsQ);
