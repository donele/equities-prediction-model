#ifndef __HRavenPack__
#define __HRavenPack__
...
class CLASS_DECLSPEC HRavenPack: public HModule {
public:
	HRavenPack(const std::string& moduleName, const std::multimap<std::string, std::string>& conf);
	virtual ~HRavenPack();
