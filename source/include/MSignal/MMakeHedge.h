#ifndef __MMakeHedge__
#define __MMakeHedge__
...
class CLASS_DECLSPEC MMakeHedge: public MModuleBase {
public:
	MMakeHedge(const std::string& moduleName, const std::multimap<std::string, std::string>& conf);
	virtual ~MMakeHedge();
