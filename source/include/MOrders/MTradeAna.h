#ifndef __MTradeAna__
#define __MTradeAna__
...
class CLASS_DECLSPEC MTradeAna: public MModuleBase {
public:
	MTradeAna(const std::string& moduleName, const std::multimap<std::string, std::string>& conf);
	virtual ~MTradeAna();
